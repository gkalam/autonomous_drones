...
echo "${green}Starting installation of caffe_ros and osdk_controller ROS packages...${reset}"
cd $HOME
...
if [ ! -L "$CATKIN_WS/src/caffe_ros" ]; then
    ...
    ln -s $HOME/redtail/ros/packages/osdk_controller $CATKIN_WS/src/
fi
...
echo "Building osdk_controller package..."
catkin_make osdk_controller_node
