...
/**
    osdk_controller ROS node. Implements simple waypoint based controller for PX4/Mavros flightstack.
...
#ifndef OSDK_CONTROLLER_OSDK_CONTROLLER_H
#define OSDK_CONTROLLER_OSDK_CONTROLLER_H
