...
namespace osdk_control
{

OSDKController::OSDKController()
{
...
bool OSDKController::Drone::init(ros::NodeHandle& nh)
{
    is_initialized_ = true;
    return true;
}

void OSDKController::Drone::executeCommand(const OSDKController& ctl, const geometry_msgs::PoseStamped& goto_pose,
...
bool OSDKController::APMRoverRC::init(ros::NodeHandle& nh)
{
...
void OSDKController::APMRoverRC::printArgs()
{
...
void OSDKController::APMRoverRC::executeCommand(const OSDKController& ctl, const geometry_msgs::PoseStamped& goto_pose,
                                             float linear_control_val, float angular_control_val, bool has_command)
{
    ROS_ASSERT(is_initialized_);
...
bool OSDKController::APMRoverWaypoint::init(ros::NodeHandle& nh)
{
    is_initialized_ = true;
    return true;
}

void OSDKController::APMRoverWaypoint::executeCommand(const OSDKController& ctl, const geometry_msgs::PoseStamped& goto_pose,
                                          float /*linear_control_val*/, float /*angular_control_val*/, bool /*has_command*/)
{
    ROS_ASSERT(is_initialized_);
    // Publish pose update to MAVROS
...
void OSDKController::osdkStateCallback(const mavros_msgs::State::ConstPtr &msg)
{
    fcu_state_ = *msg;
}

void OSDKController::poseCallback(const geometry_msgs::PoseStamped::ConstPtr &msg)
{
...
void OSDKController::joystickCallback(const sensor_msgs::Joy::ConstPtr& msg)
{
...
void OSDKController::dnnCallback(const sensor_msgs::Image::ConstPtr& msg)
{
...
void OSDKController::objDnnCallback(const sensor_msgs::Image::ConstPtr& msg)
{
...
void OSDKController::computeDNNControl(const float class_probabilities[6], float& linear_control_val, float& angular_control_val)
{
...
bool OSDKController::parseArguments(const ros::NodeHandle& nh)
{
...
bool OSDKController::init(ros::NodeHandle& nh)
{
    ...
    fcu_state_sub_ = nh.subscribe<mavros_msgs::State>("/mavros/state", QUEUE_SIZE, &OSDKController::OSDKStateCallback, this);
    if(!fcu_state_sub_)
    {
    ...
    local_pose_sub_ = nh.subscribe<geometry_msgs::PoseStamped>("/mavros/local_position/pose", QUEUE_SIZE, &OSDKController::poseCallback, this);
    if(!local_pose_sub_)
    {
    ...
    joy_sub_ = nh.subscribe<sensor_msgs::Joy>("/joy", command_queue_size_, &OSDKController::joystickCallback, this);
    if(joy_sub_)
    {
    ...
    dnn_sub_ = nh.subscribe<sensor_msgs::Image>("/trails_dnn/network/output", command_queue_size_, &OSDKController::dnnCallback, this);
    if(dnn_sub_)
    {
    ...
    objdnn_sub_ = nh.subscribe<sensor_msgs::Image>("/object_dnn/network/output", command_queue_size_, &OSDKController::objDnnCallback, this);
    if(objdnn_sub_)
    {
...
void OSDKController::initAutopilot()
{
...
bool OSDKController::setJoystickParams(std::string joy_type)
{
...
void OSDKController::spin()
{
    if(controller_state_ != ControllerState::Armed)
    {
        ROS_INFO("Cannot spin in OSDKController node! Vehicle is not armed!");
        return;
    }
    ...
    ROS_INFO("OSDKController is processing requests...");
    ...
    while (ros::ok())
    {
        ...
        default:
            ROS_ERROR("OSDKController::spin detected unknown state: %d!", (int)controller_state_);
            break;
        }
...
inline geometry_msgs::Quaternion OSDKController::getRotationTo(geometry_msgs::Point& position, geometry_msgs::Point& target_position) const
{
...
inline geometry_msgs::Point OSDKController::computeNextWaypoint(
...
inline float OSDKController::getPoseDistance(geometry_msgs::PoseStamped& pose1, geometry_msgs::PoseStamped& pose2) const
{
...
inline float OSDKController::doExpSmoothing(float cur, float prev, float factor) const
{
