...
# Copyright (c) 2021, Department of Informatics, NKUA. All rights reserved.
...
@author: Georgios Kalampokis
"""

# How to run (example): 
# python videoParserV3.py ./pathToVideoFile.avi ./pathToframes -p video1. -e png -c 3
...
def breakVideoIntoFrames(videoFilePath, frameDirectory, namePrefix, extension, skipCount) :
    ...
    frameCount = videoReader.count_frames()
